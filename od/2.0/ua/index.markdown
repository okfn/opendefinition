...
стоcовно до знань, сприяючи стійким спільнотам в якому кожен може взяти участь, і де можливість взаємодії досягає максимуму.
...
Це визначення відповідає значенню терміна "відкрите" по відношенню до програмного забезпечення ([Open Source Definition](http://www.opensource.org/docs/osd) і є синонімом слова "вільно" у сенсі "свобода", як і у [визначенні вільних творів культури (Definition of Free Cultural Works)](http://freedomdefined.org). Визначення відкритості було започатковне з Open Source Definition, яке, в свою чергу, є похідним від [Debian Free Software Guidelines](http://www.debian.org/social_contract).
