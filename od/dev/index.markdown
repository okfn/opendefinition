---
layout: page
title: Open Definition Development
---

Version Development. This is not an official version of the Open Definition. View the ([current official version](/od/{{site.od_current_version}}/en/)).
